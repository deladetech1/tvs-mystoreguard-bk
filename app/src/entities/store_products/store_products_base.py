...
# =====================================================
# STORE PRODUCT BASE DTOs
# =====================================================

class StoreProductBase(BaseModel):
    """Base DTO for store product information"""
    product_id: str = Field(..., description="Product ID")
    current_qty: int = Field(..., ge=0, description="Current quantity in store")
    ...
    is_active: bool = Field(default=True, description="Whether the store product is active")
