...
class WarehouseTransferApprovalRead(BaseModel):
    """An approve/reject decision recorded against a warehouse transfer"""
    id: str
...
class WarehouseTransferReadBase(BaseModel):
    ...
    approvals: List[WarehouseTransferApprovalRead] = Field(default_factory=list, description="Approve/reject decision history")
