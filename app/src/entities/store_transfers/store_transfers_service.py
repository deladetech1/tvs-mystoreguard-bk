...
class StoreTransfersService:
    ...
    def create_store_transfer(
        ...
        try:
            with DatabaseManager.transaction() as cursor:
                ...
                # Verify source location exists and is a STORE
                cursor.execute(
                ...
                # Verify source store product exists
                cursor.execute(
                ...
                if not source_store_product:
                    return Respons(
                        success=False,
                        detail=f"Product not found in source store location",
                ...
                transfer_dict = dict(transfer_with_details) if transfer_with_details else {}
                ...
                try:
                    ActivityLogService.log_activity(
                        ...
                        description=f"Store transfer {transfer_number} created successfully",
    ...
    def _execute_transfer(
        ...
        try:
            ...
            source_type = transfer['source']  # 'STORE' for store transfers
