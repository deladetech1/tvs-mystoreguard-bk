...
class StoreConfigBase(BaseModel):
    ...
    enable_daily_sales_reports: bool = Field(default=False, description="Whether to enable daily reports")
    ...
    sales_items_notification_email: Optional[str] = Field(None, description="Comma-separated list of email addresses to receive daily sales reports")
